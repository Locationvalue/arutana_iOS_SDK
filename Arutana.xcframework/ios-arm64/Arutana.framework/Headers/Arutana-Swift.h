...
// Generated by Apple Swift version 6.3.3 (swiftlang-6.3.3.1.1 clang-2100.1.1.101)
#ifndef ARUTANA_SWIFT_H
#define ARUTANA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Arutana",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
/// ATT ダイアログ表示 & IDFA 取得を扱うシングルトンユーティリティ
SWIFT_CLASS("_TtC7Arutana17AdTrackingUtility")
@interface AdTrackingUtility : NSObject
/// シングルトンインスタンス
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AdTrackingUtility * _Nonnull shared;)
+ (AdTrackingUtility * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// iOS 13: <code>isAdvertisingTrackingEnabled</code>→<code>advertisingIdentifier</code> で同期取得
/// iOS 14+: ATT 許可状況に応じて非同期にダイアログを表示 or 同期取得
/// \param completion 許可済みなら実 IDFA（UUID）を返し、拒否／制限／iOS13 実行時はゼロ UUID を返す
///
- (void)requestTrackingAuthorizationWithCompletion:(void (^ _Nonnull)(NSString * _Nonnull))completion;
@end
...
- (void)setIDFA:(NSString * _Nullable)idfa;
...
SWIFT_ENUM_FWD_DECL(NSInteger, kArutanaLogLevel)
SWIFT_CLASS_NAMED("ArutanaLogger")
@interface ArutanaLogger : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum kArutanaLogLevel logLevel;)
+ (enum kArutanaLogLevel)logLevel SWIFT_WARN_UNUSED_RESULT;
+ (void)setLogLevel:(enum kArutanaLogLevel)value;
+ (void)outputDebug:(NSString * _Nonnull)str cls:(Class _Nullable)cls method:(SEL _Nullable)method;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM_NAMED(NSInteger, kArutanaLogLevel, "LogLevel", open) {
  kArutanaLogLevelDebug = 0,
  kArutanaLogLevelInfo = 1,
...
@class NSTimer;
SWIFT_CLASS("_TtC7Arutana13InArutunaUtil")
@interface InArutunaUtil : NSObject
